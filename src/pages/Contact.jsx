    ...
    <main className="page-shell">
      <div className="section-wrap">
        <section className="mb-8 grid gap-6 overflow-hidden rounded-3xl bg-[#102d5a] p-7 text-white sm:p-10 lg:grid-cols-[1fr_auto] lg:items-end">
          ...
          <a href="https://www.google.com/maps/search/?api=1&query=FGH+12A+Capital+High+Street+Bhiwadi+Alwar+Rajasthan+301019" target="_blank" rel="noreferrer" className="button-primary bg-white text-blue-700 hover:bg-blue-50">Open in Google Maps ↗</a>
        </section>
          ...
          <div className="space-y-6">
            <section className="surface p-6 sm:p-8">
              ...
              <div className="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-1">
                <a href="https://www.google.com/maps/search/?api=1&query=FGH+12A+Capital+High+Street+Bhiwadi+Alwar+Rajasthan+301019" target="_blank" rel="noreferrer" className="contact-item"><span className="contact-icon">⌖</span><span><b>Visit our store</b><small>FGH 12A, Capital High Street<br />Bhiwadi, Alwar, Rajasthan 301019</small></span></a>
            ...
            <div className="overflow-hidden rounded-[1.25rem] border border-slate-200 bg-white shadow-sm">
              <iframe title="SuperMart location at FGH 12A, Capital High Street" src="https://www.google.com/maps?q=FGH%2012A%20Capital%20High%20Street%20Bhiwadi%20Alwar%20Rajasthan%20301019&output=embed" className="h-72 w-full border-0 sm:h-80" loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
            </div>
          </div>
