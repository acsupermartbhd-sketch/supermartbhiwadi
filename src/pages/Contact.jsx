    ...
    <main className="page-shell">
      <div className="section-wrap">
        <section className="mb-8 grid gap-6 overflow-hidden rounded-3xl bg-[#102d5a] p-7 text-white sm:p-10 lg:grid-cols-[1fr_auto] lg:items-end">
          ...
          <a href="https://www.google.com/maps/search/?api=1&query=FG+19-20+Capital+High+Street+Bhiwadi+Alwar+Rajasthan+301019" target="_blank" rel="noreferrer" className="button-primary bg-white text-blue-700 hover:bg-blue-50">Open in Google Maps ↗</a>
        </section>
